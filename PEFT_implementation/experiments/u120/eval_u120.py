...
ADAPTER_DIR = "/workspace/runs/tinylora_u120_gsm8k/final"
MERGED_DIR = "/workspace/runs/tinylora_u120_gsm8k/merged"
RESULTS_PATH = "/workspace/runs/tinylora_u120_gsm8k/eval_results.jsonl"
MAX_NEW_TOKENS = 1024
PAPER_REF = 0.95
PAPER_LABEL = "~95% (paper claim for u=120)"
PAPER_REF = 0.95        # paper claim for u=120 (~95% from Section 6.1)
PAPER_LABEL = "~95% (paper claim for u=120)"
...
def evaluate():
    ...
    print(f"  Paper:   {PAPER_REF:.4f}   ({PAPER_LABEL})")
    print(f"  Delta:   {(acc - PAPER_REF)*100:+.2f} pp")
    print(f"{'='*40}")
