...
with u=13, weight_tying=1.0 -> 13 trainable parameters.
...
OUTPUT_DIR = "/workspace/runs/tinylora_u13_lr5e5_gsm8k"
SEED = 42

# TinyLoRA: r=2 (paper's main setting), u=13, full weight tying -> 13 params total
