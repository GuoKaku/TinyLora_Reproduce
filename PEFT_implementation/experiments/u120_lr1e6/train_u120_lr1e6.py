...
with u=120, weight_tying=1.0 -> 120 trainable parameters.
...
OUTPUT_DIR = "/workspace/runs/tinylora_u120_lr1e6_gsm8k"
SEED = 42

# TinyLoRA: r=2 (paper's main setting), u=120, full weight tying -> 120 params total
