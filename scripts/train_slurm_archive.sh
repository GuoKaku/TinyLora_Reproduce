#!/bin/bash
#SBATCH --job-name=tinylora_gsm8k
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
JOB_NAME="${JOB_NAME:-tinylora_gsm8k}"
CONFIG_PATH="${CONFIG_PATH:-configs/qwen25_7b_tinylora_gsm8k.yaml}"
...
python -m tinylora_gsm8k.train_grpo --config "$RUNTIME_CONFIG"
